...
//                property int h: Script.getHeight(content)
                property int w: img_w
                property int h: img_h
...
//                }
            ...
            State {
                ...
                PropertyChanges { target: hqImage; source: listItem.ListView.isCurrentItem ? /*"../" + src*/ "" : ""; visible: true }
            }
            ]
            ...
            Transition {
                ...
                SequentialAnimation {
                    PauseAnimation { duration: 10 * Math.abs(index)  }
                    ParentAnimation {
